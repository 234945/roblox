...
local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/234945/roblox/main/exc/flags"))()
local Esp = loadstring(game:HttpGet("https://raw.githubusercontent.com/234945/roblox/main/exc/esp"))()
Esp.Enabled = false
Esp.Tracers = false
Esp.Boxes = false

local Window = Library:CreateWindow("Goofy Evade 🐒", Vector2.new(500, 300), Enum.KeyCode.RightShift)
...
Credits:AddLabel("Developed By Scorpio#0003")
Credits:AddLabel("discord.gg/exodium")
